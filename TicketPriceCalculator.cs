...
<div class="navbar navbar-default navbar-fixed-top" id="top-navbar">
	...
	<div class="navbar-right-container navbar-right">
		<div class="btn-group navbar-btn user-info">
				<div class="dropdown">
					<a class="user-name dropdown-toggle" data-toggle="dropdown">			
						<span id="account-display-name">ElsaSnow</span> <span class="caret"></span><br/>
					</a>
					<ul class="dropdown-menu academy-dropdown-menu" role="menu">
							<li><a href="/Account/MyFiddles">My Fiddles</a></li>
	...
	<span class="navbar-email">soniasnowden8@gmail.com</span>
...
<option selected="selected" value="NetLatest">Latest (.NET 9)</option>
...
<div id="sponsor-8" class="container-sponsor container-sponsor-pandaflow" style="display: none;">
    ...
    <script src="/bundles/common?v=SxT_kogCY_OKV_Tb-rUTdO3vtBwbYFTgyCaGRfwEb_A1"></script>
